...
import imgListenAndGues from './../../assets/img/listen-and-guess.svg'
import { Link} from 'react-router-dom';


const Games = ({playWords}) => {
    ...
    const GAMES = [
        ...
        {img: imgListenAndGues, path: 'check-it', name: 'Check correct word', description: 'Check correct word' },
    ]

    return (
        <div className={styles.gameContainer}>
            {GAMES.map((game, index) => {
               return <Link key={index} to={'game/' + game.path}>
